...
* Or, in French, German or Italian, a word: the gender will be lookup in the dictionnary.
* Or, in French, German or Italian, `#[+value('bague', {represents: PRODUIT})]` will output _bague_ *and* set the gender of `PRODUIT` to `F` via the dictionnary.
