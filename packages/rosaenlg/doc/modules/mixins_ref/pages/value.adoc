...
* use `agree` for `ORDINAL_TEXTUAL` in `it_IT`, for instance to have _prima_ and not _primo_ (default agreement is `M`)
...
| `ORDINAL_TEXTUAL` | yes | yes (up to 100) | yes (up to 1 million included)
| `FORMAT` | yes | yes | yes
|=====================================================================
