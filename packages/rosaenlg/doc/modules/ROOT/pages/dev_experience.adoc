...
*Develop* directly in the browser using the link:https://rosaenlg.org/ide/demo_en_US.html[browser IDE]:

* Put your test data directly in the template
* Render your test texts directly in the browser

image::browser_dev.png.png[Development in the browser]
...
See https://rosaenlg.org/openapi/redoc-static.html[swagger here].
