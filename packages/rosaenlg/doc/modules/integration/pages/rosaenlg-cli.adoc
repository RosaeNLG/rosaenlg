...
* generate JSON packages of the templates (to run them in xref:java-server:java-server.adoc[RosaeNLG Java Server])
...
You have developed your templates somewhere (in multiples files with `include`) and now you want to package them in a single JSON file to upload them in a xref:java-server:java-server.adoc[RosaeNLG Java Server].
