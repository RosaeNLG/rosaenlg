...
link:https://gitlab.com/rosaenlg-projects/boilerplate/[boilerplate project] is a standard NLG project using RosaeNLG and following (my) best practices that you can fork to start your own RosaeNLG project.
