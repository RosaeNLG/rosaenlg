...
Pronominal form using `pronominal:true`: `er #[+subjectVerb(subjS, {verb:'waschen', aux:'HABEN', tense:'FUTUR2', pronominal:true})] die Hände #[+verbPart]` will output _er wird sich die Hände gewaschen haben_.
