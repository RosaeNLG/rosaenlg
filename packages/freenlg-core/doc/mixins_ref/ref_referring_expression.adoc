anchor:referring_expression[Referring Expressions]
...
* Or, in French, `#[+value('bague', {represents: PRODUIT})]` will output _bague_ *and* set the gender of `PRODUIT` to `F` via the dictionnary.
