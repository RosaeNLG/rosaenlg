...
TIP: This tutorial focuses on server-side rendering using node.js. But you can run your templates client side xref:integration:browser_ide.adoc[in the browser].
