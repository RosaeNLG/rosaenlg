...
* boilerplate moved to github: https://github.com/RosaeNLG/rosaenlg-boilerplate
...
* updated logo (font is link:https://www.dafont.com/fr/soft-elegance.font?l[]=10&l[]=1[Soft Elegance])
...
* *removed `substantive` mixin:* use `value` instead with `number` param, see xref:mixins_ref:value_nominal_groups.adoc.adoc[Value for Nominal Groups]
