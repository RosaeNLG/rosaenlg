...
* `sentence` mixin to generate complete sentences using a description tree with subject, verb, complement. Support is beta (work in progress) and *limited to French*. See xref:mixins_ref:sentences.adoc[Sentences documentation].
