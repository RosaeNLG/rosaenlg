...
Github project is https://github.com/RosaeNLG/rosaenlg-java[here]. See https://github.com/RosaeNLG/rosaenlg-java/blob/master/CHANGELOG.md[changelog].
...
The war file is published on https://repo1.maven.org/maven2/org/rosaenlg/java-server/[maven].
...
https://www.javadoc.io/doc/org.rosaenlg/java-server/[JavaDoc is here]
